...
# Line test/calib_2.prg:2
################### Start module ODC_hotwirez ####################
pyrapid.Symbols().PushScope('ODC_hotwirez', None)
##################################################################
############################# start declaration
# Line test/calib_2.prg:4
pyrapid.Symbols().AddGlobalSym('hotwirez', pyrapid.Symbol.CreatePers(pyrapid.Symbols().GetSymbol(symbolname='tooldata', modulename='ODC_hotwirez', functionname=None).data([True, [[0.0, 0.0, 733.0], [1.0, 0.0, 0.0, 0.0]], [10.0, [0.04, 0.0, 733.0], [1, 0, 0, 0], 0, 0, 0]])))
# end declaration
############################# start declaration
# Line test/calib_2.prg:5
pyrapid.Symbols().AddGlobalSym('Pos_Offset', pyrapid.Symbol.CreatePers(pyrapid.Symbols().GetSymbol(symbolname='pos', modulename='ODC_hotwirez', functionname=None).data([0, 0, 0])))
# end declaration
############################# start declaration
# Line test/calib_2.prg:6
pyrapid.Symbols().AddGlobalSym('cur_vel', pyrapid.Symbol.CreatePers(pyrapid.Symbols().GetSymbol(symbolname='speeddata', modulename='ODC_hotwirez', functionname=None).data([200.0, 200.0, 1000.0, 1000.0])))
# end declaration
############################# start declaration
# Line test/calib_2.prg:7
pyrapid.Symbols().AddGlobalSym('cur_zone', pyrapid.Symbol.CreatePers(pyrapid.Symbols().GetSymbol(symbolname='zonedata', modulename='ODC_hotwirez', functionname=None).data([False, 1, 1, 50, 0.1, 50, 0.1])))
# end declaration
############################# start declaration
# Line test/calib_2.prg:8
# end declaration
##################################################################
pyrapid.Symbols().PopScope()
################### End module ODC_hotwirez ####################
